...
export default class ReactNativeUniqueSelectize extends React.Component {
  static propTypes = {
  ...
  _onSubmitEditing = callback => {
    ...
    // @lière tweaked this instruction to push
    // alwways just one item in the selectedItems array
     
      selectedItems.result[0] = text;
      selectedItems.entities.item[0] = item;
      this._setSelectedItems(selectedItems);
    }
    this.setState({ text: '' });
